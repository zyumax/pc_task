...
INSERT INTO documents (directory_id, user_id, parent_id, documents_name, content) VALUES
(1, 1, NULL, 'ドキュメント1', 'サンプルテキスト1'),
(1, 1, NULL, 'ドキュメント2', 'サンプルテキスト2'),
(1, 2, 1, 'ドキュメント3', 'サンプルテキスト3'),
(2, 1, NULL, 'ドキュメント4', 'サンプルテキスト4'),
(2, 1, 4, 'ドキュメント5', 'サンプルテキスト5'),
(2, 1, 4, 'ドキュメント6', 'サンプルテキスト6'),
(3, 2, NULL, 'ドキュメント7', 'サンプルテキスト7'),
(3, 2, 7, 'ドキュメント8', 'サンプルテキスト8'),
(4, 2, NULL, 'ドキュメント9', 'サンプルテキスト9'),
(5, 2, NULL, 'ドキュメント10', 'サンプルテキスト10');
